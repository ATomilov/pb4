<div class="row">
    <div class="col-xs-12">
        ...
        <div class="videoWrapper">
            <iframe width="100%" height="auto" style="min-height:500px" src="//www.youtube.com/embed/<?php echo $youtube_code;?>?rel=0&hd=1" frameborder="0" allowfullscreen>
            </iframe>
        </div>
    </div>
    <div class="col-xs-8">
    ...
    <div class="col-xs-4">
        <h2>
            <a href="?course_id=0">"<?php echo $olCourse->name;?>"</a>
        </h2>
        <?php
...
<script>
    function setCookie(e, o, i) {
        ...
        r && r.toUTCString && (i.expires = r.toUTCString()), o = encodeURIComponent(o);
        var n = e + "=" + o;
        for (var a in i) {
            n += "; " + a;
            var m = i[a];
