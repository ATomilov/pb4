		...
		<div class="form-caption">
			<div class="item">
				<?php $current_lang = apply_filters('wpml_current_language', null);
					if ($current_lang == 'en'): ?>
					<a href="/en/forgot-password" class="form-link important">
						<?php _e('Forgot Password?', 'ol_plugin');?>
					</a>
					<?php else: ?>
					<a href="/mot-de-passe-oublie" class="form-link important">
						<?php _e('Forgot Password?', 'ol_plugin');?>
					</a>
				<?php endif;?>
			</div>
			<div class="item">
				...
				if ($current_lang == 'en'): ?>
					<a href="/en/register" class="form-link important">
						<?php _e('Register now.', 'ol_plugin');?>
					</a>
				<?php else: ?>
					<a href="/register" class="form-link important">
						<?php _e('Register now.', 'ol_plugin');?>
					</a>
				<?php endif;?>
			</div>
