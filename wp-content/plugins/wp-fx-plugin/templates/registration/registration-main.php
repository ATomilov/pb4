<form method="post" class="registeringForm" action="#">
	...
	<div class="text-center">
		<button type="submit" class="btn btn-success btn-lg btn-circle"><?php _e('Register', 'Template'); ?></button>
	</div>
...
<script type="text/javascript">
	...
	(function($) {
		...
		olSdkClient.connectRegistrationForm({
			...
			'detectCountry': true,
			'success': function() {
				setTimeout(function() {window.location.replace('/trading/#!/pl-fb/account/deposit/request');}, 100);
