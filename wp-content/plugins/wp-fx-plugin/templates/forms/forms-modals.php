            ...
            <div class="modal-body">
                <div class="account-modal-form">
                    <form class="loginForm">
                        ...
                        <label>
                            <div class="icheckbox_flat-yellow" style="position: relative;">
                                <input type="checkbox" name="quux[1]" class="icheckbox_flat-yellow" style="position: absolute; opacity: 0;">
                                <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background-color: rgb(255, 255, 255); border: 0px; opacity: 0; cursor: pointer; background-position: initial initial; background-repeat: initial initial;">
                                </ins>
                            </div>
