...
function wp_options_page() {
    ?>
    <div class="wrap">
        <h1>Optionlift WP Plugin settings</h1>
...
function display_theme_panel_fields()
{
    ...
    olAddTextSettings('ol_api_url', 'Crm server', "api-section");
    olAddTextSettings('ol_rates_url', 'Rates server', "api-section");
    olAddTextSettings('ol_static_url', 'Static server', "api-section");
